    ...
    return (
        ...
        >
            <div className="px-6 pt-0 pb-6">
                <a
                    href={getGoogleURL()}
                    className="group mb-1 flex items-center rounded-md bg-purple-600 py-3 px-6 text-gray-100 transition  duration-300 hover:bg-black dark:text-gray-900 dark:hover:bg-white"
                >
                    <GoogleBAWIcon />
